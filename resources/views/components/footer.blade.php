        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                <div class="flex items-center gap-2">
                    <div class="h-8 w-8 rounded-lg bg-indigo-600">
                ...
                <div class="mt-4 flex items-center gap-3 text-gray-500">
                    @if(!empty($siteSettings->twitter_url))
                        <a href="{{ $siteSettings->twitter_url }}" target="_blank" aria-label="Twitter" class="inline-flex h-8 w-8 items-center justify-center rounded-md border border-gray-300 hover:text-gray-700">
                    ...
                    @if(!empty($siteSettings->instgram_url))
                        <a href="{{ $siteSettings->instgram_url }}" target="_blank" aria-label="Instagram" class="inline-flex h-8 w-8 items-center justify-center rounded-md border border-gray-300 hover:text-gray-700">
                    ...
                    <a href="{{ $siteSettings->facebook_url }}" target="_blank" aria-label="Facebook" class="inline-flex h-8 w-8 items-center justify-center rounded-md border border-gray-300 hover:text-gray-700">
                        <svg class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    @if(!empty($siteSettings->email_address))
                        <a href="mailto:{{ $siteSettings->email_address }}" target="_blank" aria-label="Email" class="inline-flex h-8 w-8 items-center justify-center rounded-md border border-gray-300 hover:text-gray-700">
                            <svg class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
