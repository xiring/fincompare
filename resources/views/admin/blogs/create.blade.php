<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Create Blog Post') }}</h2>
    </x-slot>

    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <form action="{{ route('admin.blogs.store') }}" method="post" class="max-w-3xl space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <x-text-input id="featured_image" name="featured_image" value="{{ old('featured_image') }}" class="mt-1 block w-full" />
                    </div>
