<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Partners') }}</h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('admin.partners.create') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-md">New Partner</a>
                </div>
            </div>
                        ...
                        <tbody class="divide-y">
                            @foreach($partners as $partner)
                                <tr>
                                    ...
                                    <td class="px-3 py-2">{{ $partner->slug }}</td>
                                    <td class="px-3 py-2">{{ $partner->status }}</td>
                                    <td class="px-3 py-2 text-right space-x-2">
                                        <a href="{{ route('admin.partners.edit', $partner) }}" class="text-indigo-700 hover:underline">Edit</a>
