                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @auth
                        ...
                        <x-dropdown align="left" width="48" class="flex items-center">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('admin.blogs.index')" :active="request()->routeIs('admin.blogs.*')">
                                    {{ __('Blogs') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('admin.cms-pages.index')" :active="request()->routeIs('admin.cms-pages.*')">
                                    {{ __('CMS Page') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('admin.faqs.index')" :active="request()->routeIs('admin.faqs.*')">
                                    {{ __('FAQs') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
