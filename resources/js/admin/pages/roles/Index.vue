  ...
  <div>
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      <div>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Manage user roles</p>
      </div>
      <router-link
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          <thead class="bg-gray-50 dark:bg-gray-900">
            <tr>
              ...
              <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Permissions</th>
          ...
          <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tr v-else-if="roles.length === 0" class="text-center">
              <td colspan="3" class="px-6 py-12 text-gray-500 dark:text-gray-400">No roles found</td>
            </tr>
            <tr v-else v-for="role in roles" :key="role.id" class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
              ...
              <td class="px-6 py-4">
                <div class="flex flex-wrap gap-1">
                  ...
                  <span v-if="!role.permissions || role.permissions.length === 0" class="text-xs text-gray-500 dark:text-gray-400">No permissions</span>
                  <span v-else-if="role.permissions.length > 3" class="text-xs text-gray-500 dark:text-gray-400">+{{ role.permissions.length - 3 }} more</span>
                </div>
              </td>
