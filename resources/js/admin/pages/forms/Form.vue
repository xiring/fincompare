<template>
  <div>
    <PageHeader :title="isEdit ? 'Edit Form' : 'Create Form'" :description="isEdit ? 'Update form information' : 'Add a new form'" />

    <LoadingSpinner v-if="isEdit && loading && !formData" text="Loading form..." />
    <ErrorMessage v-else-if="errorMessage" :message="errorMessage" class="mb-6" />
    <SuccessMessage v-if="successMessage" :message="successMessage" class="mb-6" />

    <FormCard v-if="!isEdit || formData">
      <form @submit.prevent="handleSubmit" class="space-y-6">
        ...
        <FormActions
          :loading="loading"
          :submit-text="isEdit ? 'Update Form' : 'Save Form'"
