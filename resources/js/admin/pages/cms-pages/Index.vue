  ...
  <div>
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      <div>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Manage CMS pages</p>
      </div>
      <router-link
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tr v-else-if="pages.length === 0" class="text-center">
              <td colspan="5" class="px-6 py-12 text-gray-500 dark:text-gray-400">No CMS pages found</td>
            </tr>
            <tr v-else v-for="page in pages" :key="page.id" class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
              <td class="px-6 py-4">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <span
                  ...
                  :class="{
                    'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-400': page.status === 'draft',
                    'bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400': page.status === 'published'
                  }"
                >
                  {{ page.status }}
                </span>
...
const handleDelete = async (page) => {
  ...
  try {
    await adminApi.cmsPages.delete(page.id);
