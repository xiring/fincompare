...
export const useProductCategoriesStore = defineStore('productCategories', () => {
  ...
  const fetchItem = async (id) => {
    ...
    error.value = null;
    try {
      const response = await adminApi.productCategories.show(id);
  ...
  const createItem = async (data) => {
    ...
    error.value = null;
    try {
      const response = await adminApi.productCategories.create(data);
  ...
  const updateItem = async (id, data) => {
    ...
    error.value = null;
    try {
      const response = await adminApi.productCategories.update(id, data);
  ...
  const deleteItem = async (id) => {
    ...
    error.value = null;
    try {
      await adminApi.productCategories.delete(id);
