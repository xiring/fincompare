...
export const useCmsPagesStore = defineStore('cmsPages', () => {
  ...
  const fetchItem = async (id) => {
    ...
    error.value = null;
    try {
      const response = await adminApi.cmsPages.show(id);
  ...
  const createItem = async (data) => {
    ...
    error.value = null;
    try {
      const response = await adminApi.cmsPages.create(data);
  ...
  const updateItem = async (id, data) => {
    ...
    error.value = null;
    try {
      const response = await adminApi.cmsPages.update(id, data);
  ...
  const deleteItem = async (id) => {
    ...
    error.value = null;
    try {
      await adminApi.cmsPages.delete(id);
