...
export const useFormsStore = defineStore('forms', () => {
  ...
  const fetchItem = async (id) => {
    ...
    error.value = null;
    try {
      const response = await adminApi.forms.show(id);
  ...
  const createItem = async (data) => {
    ...
    error.value = null;
    try {
      const response = await adminApi.forms.create(data);
  ...
  const updateItem = async (id, data) => {
    ...
    error.value = null;
    try {
      const response = await adminApi.forms.update(id, data);
  ...
  const deleteItem = async (id) => {
    ...
    error.value = null;
    try {
      await adminApi.forms.delete(id);
